...
const SignupPage = () => {
  ...
  return (
    <div className="flex flex-col  min-h-screen justify-center items-center px-5 py-5 bg-orange-100">
      <h3 className="text-black font-medium text-3xl mb-3">Welcome To Vyas!</h3>
